...
def create_example(paragraph_text, question_text):
...
def _load():
    ...
    model_state_dict = torch.load(args.output_model_file, map_location="cpu")
    model = BertForQuestionAnswering.from_pretrained(args.bert_model, state_dict=model_state_dict)
    model.to(args.device)
    model.eval()

    globals()["bert_tokenizer"] = BertTokenizer.from_pretrained(args.bert_model)
    globals()["bert_model"] = model
    globals()["_args"] = args


def qa_system_predict(paragraph_text, question_text):
    args = globals()["_args"]
    tokenizer = globals()["bert_tokenizer"]
    model = globals()["bert_model"]

    eval_examples = [create_example(paragraph_text, question_text)]
